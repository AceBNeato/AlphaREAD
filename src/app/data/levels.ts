...
export const CVC_ASSESSMENT_WORDS = [
  "BAT", "BED", "PIG", "BOX", "BUG", "CAN", "CAR", "CAT", "CUP", "DOG", 
  "FAN", "GUM", "HAM", "HAT", "JAM", "SUN", "MAN", "NET", "MAP", "PAN", 
  "PEN", "PIN", "POT", "RAG", "RAM", "RAT", "RUG", "TUB", "VAN", "WIG"
];
...
export const LONG_VOWELS_SENTENCES: string[] = [
  ...
  "The bee is cute.",
  "The bed is wide and big.",
  "Gab wants me to be on his right side.",
  "The tea is so hot.",
  "Tom and Max like to eat hot cake.",
  "Delete my name inside the mail.",
  ...
  "Jade, fix the bed well.",
  "Ted has five pairs of socks.",
  "We ate a sweet pie.",
  "Kent gave me five dogs.",
  "Jen got a hot cake.",
  ...
  "Let's go home late.",
  "The soap has a sweet smell.",
  "The road has bike lanes.",
  "The red coat fits Jane.",
  "Keep your tone low.",
  "Let's make five rows.",
  "The cake mom bakes is on the pan.",
  "Yen will use her bike.",
  "The cube is so cold.",
